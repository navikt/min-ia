...
export const kurslisteMock = [
  {
    ...
    RegistrationToDateTime: getIsoDateWithTime(
      getTomorrowsDate(),
      "T15:00:00.000Z"
    ),
    RegistrationPlaceName: "Digitalt - Teams samling",
    RegistrationID: "a162o00000Ajzx9AAB",
    RegistrationFromDateTime: getIsoDateWithTime(
      getTomorrowsDate(),
      "T09:00:00.000Z"
    ),
  ...
  },
  {
    ...
    FrontPageDescription:
      "<p>I samlingen vil vi se på det teoretiske grunnlaget for valgene som er tatt for prosessen i HelseIArbeid, og deretter knytte det konkret til møter og moduler.</p><p>Samlinga er dialogbasert og en arena for erfaringsdeling og å lære av hverandre.</p><p>Målgruppe er IA-rådgivere som jobber/skal jobbe med HelseIArbeid.</p>",
    Description:
      "Nettverkssamling om Prosessledelse med spesielt fokus på HelseIArbeid.",
    configurable_custom: {
      Underkategori: null,
  ...
  {
    Title:
      "Spørsmål og svar - et webinar om sykefravær, sykmeldinger og ferietid",
    ShowInActivityList: 0,
    ...
    MaxNumberOfParticipants: 150,
    FrontPageDescription:
      "<p>NAV Arbeidslivssenter Rogaland inviterer til digitalt møte med hovedtema knyttet til sykefravær. Vi vil besvare spørsmål som er innsendt i forkant av møtet. Dersom det er tid igjen vil vi også besvare spørsmål under direkte sending. Det vil ikke være mulig å ta opp enkeltsaker. Spørsmål kan sendes på epost til: marit.fuglestein.kristensen@nav.no</p>",
    Description:
      "Digitalt møte om sykefravær generelt for målgruppen arbeidsgivere.",
    configurable_custom: {
      Underkategori: null,
      Type: "Webinar",
      Tema: "Inkluderende arbeidsliv (IA)",
