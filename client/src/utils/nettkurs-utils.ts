...
export const IAVideoer: QbrickVideo[] = [
    {
        ...
        metadata: {
            ...
            "description": "Gode grep i krisetider. Koronapandemien har satt oss i en krevende og spesiell situasjon. Hva kan du som leder gjøre for dine ansatte og deg selv?\n\nMer informasjon:\nFor arbeidsgivere: https://arbeidsgiver.nav.no/kontakt-oss/\n\nFor personbrukere: https://www.nav.no/person/koronaveiviser"
        },
    },{
