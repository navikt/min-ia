  ...
  return (
    <>
      ...
      >
        <Sideinnhold
          offentligId={
            typeof offentligId === "string" ? offentligId : undefined
          }
          setOffentligId={(nyOffentligId: string) =>
            replace(`/samarbeid/${nyOffentligId}`)
          }
...
export async function getServerSideProps() {
  const page = {
    title: "Samarbeidsdetaljer",
    description: "Detaljer om et samarbeid mellom NAV og en arbeidsgiver",
  };
