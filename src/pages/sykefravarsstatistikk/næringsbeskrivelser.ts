import { Næring, Næringskode5Siffer } from "./mockdata";
...
const næringsbeskrivelser = [
  ...
  {
    kode: "23",
    navn: "Produksjon av andre ikke-metallholdige mineralprodukter",
  },
  { kode: "24", navn: "Produksjon av metaller" },
  { kode: "25", navn: "Produksjon av metallvarer, unntatt maskiner og utstyr" },
  {
    kode: "26",
    navn: "Produksjon av datamaskiner og elektroniske og optiske produkter",
  },
  ...
  {
    kode: "38",
    navn: "Innsamling, behandling, disponering og gjenvinning av avfall",
  },
  ...
  {
    kode: "66",
    navn: "Tjenester tilknyttet finansierings- og forsikringsvirksomhet",
  },
  ...
  {
    kode: "79",
    navn: "Reisebyrå- og reisearrangørvirksomhet og tilknyttede tjenester",
  },
  ...
  {
    kode: "91",
    navn: "Drift av biblioteker, arkiver, museer og annen kulturvirksomhet",
  },
  { kode: "92", navn: "Lotteri og totalisatorspill" },
  {
    kode: "93",
    navn: "Sports- og fritidsaktiviteter og drift av fornøyelsesetablissementer",
  },
...
export const næringskodeTilNæring = (
...
export const mapTilNæringsbeskrivelse = (
  næringskode2siffer: string
): string | undefined =>
  næringsbeskrivelser.find(
    (beskrivelse) => beskrivelse.kode === næringskode2siffer
  )?.navn;
