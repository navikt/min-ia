...
export default async function handler(
  ...
  if (erIProd) {
    backendLogger.warn(`Endepunkt /v2/organisasjoner-med-statistikktilgang er ikke tilgjengelig i cluster '${process.env.NAIS_CLUSTER_NAME}' eller NODE_ENV '${process.env.NODE_ENV}'`);
