  ...
  return (
    <Page.Block width="xl" className={styles.verktøyOgRessurser}>
      ...
      <VStack gap="4" className={styles.verktøyStack}>
        ...
        >
          <b>Arbeidsmiljøportalen</b> har gode verktøy for å bedre
          arbeidsmiljøet
        </Verktøykort>
        <Verktøykort lenke={IDEBANKEN_URL} lenketekst="Idébanken">
          På <b>Idébanken</b> finner du ideer, erfaringer og verktøy for bedre
          arbeidsmiljø og lavere sykefravær
        </Verktøykort>
        <Verktøykort lenke={SAMTALESTØTTE_URL} lenketekst="nav.no">
          <b>Samtalestøtten</b> gir gode råd for gjennomføring av samtaler med
          ansatte
        </Verktøykort>
      </VStack>
    </Page.Block>
