...
export const ManglerRettigheterIAltinnSide: React.FunctionComponent<Props> = ({
  ...
  const harRestOrganisasjonerMedStatistikk =
    restOrganisasjonerMedStatistikk.status === "Suksess" &&
    restOrganisasjonerMedStatistikk.data.length > 0;
  return (
      ...
      <div className={styles["mangler-rettigheter-i-altinn"]}>
        ...
        <div className={styles["mangler-rettigheter-i-altinn__overskrifter"]}>
          <BodyShort
            ...
            spacing
          >
            Du mangler tilgang i Altinn for å se sykefraværsstatistikk for denne
            virksomheten. Ta kontakt med den i organisasjonen din som kan
            delegere tilganger.
          </BodyShort>
          <BodyShort
            className={styles["mangler-rettigheter-i-altinn__overskrift"]}
            spacing
          >
            Altinn-tilgangen heter &quot;Virksomhetens legemeldte
