...
export const HvilkenStatistikkVisesIkkeHer: FunctionComponent = () => {
  ...
  const panelHeaderMedStyle = (
    <>
      Hvilken statistikk vises{" "}
      <span style={{ textDecoration: "underline" }}>ikke</span> her?
    </>
  );
  return (
    <ReadMore
    ...
    >
      ...
      >
        <BodyShort spacing>
          Vi viser ikke egenmeldt sykefravær. Grunnet personvern viser vi ikke
          statistikk for diagnoser, kjønn, alder eller geografi.
        </BodyShort>
        <BodyShort spacing>
          Vi sender aldri ut statistikk på mail. Dersom flere i virksomheten
          skal se statistikken, må de ha tilgangen “Sykefraværsstatistikk for
          virksomheter”. Dette administreres i Altinn.
        </BodyShort>
      </div>
    </ReadMore>
  );
