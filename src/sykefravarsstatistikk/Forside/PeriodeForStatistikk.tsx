...
export const PeriodeForStatistikk: FunctionComponent<{
    ...
    if (status === RestStatus.Suksess) {
        const periode = getPeriodeMedDato(restPubliseringsdatoer.data.gjeldendePeriode);
        return (
            <Heading spacing size="small" level="2">
                Sykefraværsstatistikken er fra perioden <span style={{fontWeight: "normal"}}>{periode}</span>
            </Heading>
