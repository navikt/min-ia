...
export const API_BASE_PATH_V2 =
  "/forebygge-fravar/api/authenticated/sykefravarsstatistikk/v2";
...
export const SAMTALESTØTTE_URL =
  "https://www.nav.no/arbeidsgiver/samtalestotte-arbeidsgiver";
