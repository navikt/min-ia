export const fiaSamarbeidMock = (test = false) => {
  if (test) {
    return [
      {
        ...
        dokumenter: [
          {
            ...
            type: "BEHOVSVURDERING",
            dato: "2025-08-29T09:39:18.828991",
          },
          {
            dokumentId: "ba7d8dc5-b363-421b-9773-7e3c2185fa87",
            type: "BEHOVSVURDERING",
...
export const fiaSamarbeidDokumentMock = (dokumentId: string) => {
  return (
    dummydokumenter.find((d) => d.dokumentId === dokumentId) ||
    dummydokumenter[0]
  );
};

const dummydokumenter = [
  {
    dokumentId: "ba7d8dc5-b363-421b-9773-7e3c2185fa86",
    type: "BEHOVSVURDERING",
    samarbeidNavn: "Bergen 4 life",
          ...
          spørsmålMedSvar: [
            {
              ...
              tekst:
                "Vi får tilbakemeldinger om at ansatte med psykiske plager blir godt ivaretatt",
              flervalg: false,
            ...
            },
            {
              ...
              tekst:
                "Vi jobber kontinuerlig for å redusere stigma rundt psykiske plager",
              flervalg: false,
              antallDeltakereSomHarSvart: 3,
              svarListe: [
                {
            ...
            },
            {
              ...
              tekst:
                "Vi har opparbeidet oss et godt grunnlag for å jobbe videre med arbeidsmiljøet vårt",
              flervalg: false,
              antallDeltakereSomHarSvart: 3,
              svarListe: [
                {
            ...
            },
            {
              ...
              tekst:
                "Vi har utarbeidet konkrete planer for hvordan vi skal videreutvikle arbeidsmiljøet vårt",
              flervalg: false,
              antallDeltakereSomHarSvart: 3,
              svarListe: [
                {
